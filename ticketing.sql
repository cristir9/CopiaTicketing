...
INSERT INTO USUARIO VALUES(2, 'admin', 'admin', 'admin', 'admin', 'admin@email.com',true,1);
INSERT INTO USUARIO VALUES(3, 'tecnico', 'tecnico', 'tecnico', 'tecnico', 'tecnico@email.com',true,2);
INSERT INTO USUARIO VALUES(4, 'gestor', 'gestor', 'gestor', 'gestor', 'gestor@email.com',true,3);
INSERT INTO USUARIO VALUES(5, 'usuario', 'usuario', 'usuario', 'usuario', 'usuario@email.com',true,9);

INSERT INTO INCIDENCIA VALUES(1, 'Incidencia 1', NOW(), NOW(), NOW(), NULL, 1, 1, 1, 1, 'Hola, soy Javier y tengo 4 años', null, 1,1);
INSERT INTO INCIDENCIA VALUES(2, 'Incidencia 2', 2023-01-12, NOW(), NOW(), NULL, 2, 1, 1, 1, 'Incidencia de nuevo', null, 1,1);
INSERT INTO INCIDENCIA VALUES(3, 'Incidencia 3', 2023-01-12, NOW(), NOW(), NULL, 2, 2, 1, 1, 'Incidencia de nuevo', null, 1,1);
